...
; TODO: It says internal for make-table, should i use make-empty-table + insert all
...
; TODO: I defined get-column-type to find operator here
; but a make-row-comparator is already defined ?
